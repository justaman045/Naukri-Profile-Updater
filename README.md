...
|---------------------|-----------------|------------------------------------------------------------------|
| Windows             | x86_64          | [NaukriProfileManager-0.4.0-windows-x86_64.exe](https://github.com/justaman045/Naukri-Profile-Updater/releases/download/v0.4.0/NaukriProfileManager-0.4.0-windows-x86_64.exe) |
| Linux               | x86_64          | [NaukriProfileManager-0.4.0-linux-x86_64.zip](https://github.com/justaman045/Naukri-Profile-Updater/releases/download/v0.4.0/NaukriProfileManager-0.4.0-linux-x86_64.zip) · [raw binary](https://github.com/justaman045/Naukri-Profile-Updater/releases/download/v0.4.0/NaukriProfileManager-0.4.0-linux-x86_64) |
| macOS (Intel)       | x86_64          | [NaukriProfileManager-0.4.0-macos-x86_64](https://github.com/justaman045/Naukri-Profile-Updater/releases/download/v0.4.0/NaukriProfileManager-0.4.0-macos-x86_64) |
| macOS (Apple Silicon) | arm64         | [NaukriProfileManager-0.4.0-macos-arm64](https://github.com/justaman045/Naukri-Profile-Updater/releases/download/v0.4.0/NaukriProfileManager-0.4.0-macos-arm64) |

> The links above point at the current `v0.4.0` release. After each new tag, the
> [Releases page](https://github.com/justaman045/Naukri-Profile-Updater/releases/latest)
...
> or `curl -LO https://github.com/justaman045/Naukri-Profile-Updater/releases/latest/download/NaukriProfileManager-0.4.0-linux-x86_64.zip`.
...
python build.py --onefile --versioned --version v0.4.0
                                         # -> NaukriProfileManager-0.4.0-<os>-<arch>
```
